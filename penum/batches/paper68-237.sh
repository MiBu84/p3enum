#!/bin/sh
#SBATCH -J paper-68-237
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim68-seed237.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim68-seed237.out.%j
#SBATCH -n 1
#SBATCH -c 16
#SBATCH -C avx
