#!/bin/sh
#SBATCH -J paper-92-98937
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim88-seed98937.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim88-seed98937.out.%j
#SBATCH -n 1
#SBATCH -c 24
#SBATCH -C avx2
