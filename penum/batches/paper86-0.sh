#!/bin/sh
#SBATCH -J paper-86-0
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim86-seed0.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim86-seed0.out.%j
#SBATCH -n 1
#SBATCH -c 24
#SBATCH -C avx2
...
do
	/home/mb31simi/NewPenum/penum/penum_no --basisfile "./inppap/svpc-e1-d$DIM-$SEED.txt" --delta 0.9999 --prebeta $PREBETA --pruneparam 0.$PRUNEPARAM --beta $BETA --sheight 10 --amax $AMAX >> paper/svpc-e1-$DIM-$SEED-r6.log
done
