#!/bin/sh
#SBATCH -J paper-92-60
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim92-seed60.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim92-seed60.out.%j
#SBATCH -n 1
#SBATCH -c 24
#SBATCH -C avx2
