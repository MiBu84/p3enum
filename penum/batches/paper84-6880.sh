#!/bin/sh
#SBATCH -J paper-84-6880
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim84-seed6880.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim84-seed6880.out.%j
#SBATCH -n 1
#SBATCH -c 24
#SBATCH -C avx2
