#!/bin/sh
#SBATCH -J scale-70
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/scale-dim70-seed0.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/scale-dim70-seed0.out.%j
#SBATCH -n 1
#SBATCH -c 60
#SBATCH -C avx
...
/home/mb31simi/NewPenum/penum/penum --basisfile "input/svpc-e1-d70.txt" --delta 0.999 --prebeta 12 --pruneparam 0.26 --beta 22 --sheight 10 --amax 2170 >> paper/scale70-e1-$DIM-$SEED-r3.log
