#!/bin/sh
#SBATCH -J paper-70-6880
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim70-seed6880.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim70-seed6880.out.%j
#SBATCH -n 1
#SBATCH -c 16
#SBATCH -C avx
