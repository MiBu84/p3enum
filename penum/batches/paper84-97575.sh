#!/bin/sh
#SBATCH -J paper-84-97575
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim84-seed97575.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim84-seed97575.out.%j
#SBATCH -n 1
#SBATCH -c 24
#SBATCH -C avx2
