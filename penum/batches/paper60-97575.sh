#!/bin/sh
#SBATCH -J paper-60-97575
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim60-seed97575.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim60-seed97575.out.%j
#SBATCH -n 1
#SBATCH -c 16
#SBATCH -C avx
