#!/bin/sh
#SBATCH -J paper-66-98937
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim66-seed98937.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim66-seed98937.out.%j
#SBATCH -n 1
#SBATCH -c 16
#SBATCH -C avx2
...
do
	/home/mb31simi/NewPenum/penum/penum --basisfile "./inppap/svpc-e1-d$DIM-$SEED.txt" --delta 0.85 --prebeta $PREBETA --pruneparam 0.$PRUNEPARAM --beta $BETA --sheight 10 --amax $AMAX >> paper/svpc-e1-$DIM-$SEED.log
done
