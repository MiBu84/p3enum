#!/bin/sh
#SBATCH -J paper-80-237
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim80-seed237.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim80-seed237.out.%j
#SBATCH -n 1
#SBATCH -c 24
#SBATCH -C avx2
