#!/bin/sh
#SBATCH -J paper-76-6880
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim76-seed6880.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim76-seed6880.out.%j
#SBATCH -n 1
#SBATCH -c 24
#SBATCH -C avx2
