...
/home/mb31simi/NewPenum/penum/penum --basisfile "input/svpc-e1-d80.txt" --delta 0.999 --prebeta 22 --pruneparam 0.14 --beta 32 --sheight 10 --amax 2300 >> paper/scale80-e1-$DIM-$SEED-r3.log
