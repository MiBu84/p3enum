#!/bin/sh
#SBATCH -J paper-70-98937
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim70-seed98937.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim70-seed98937.out.%j
#SBATCH -n 1
#SBATCH -c 16
#SBATCH -C avx
