#!/bin/sh
#SBATCH -J paper-82-98937
#SBATCH -e /home/mb31simi/NewPenum/penum/errs/paper-dim82-seed98937.err.%j
#SBATCH -o /home/mb31simi/NewPenum/penum/logs/paper-dim82-seed98937.out.%j
#SBATCH -n 1
#SBATCH -c 24
#SBATCH -C avx2
...
for ((run=1; run <= 25; run=run+1))
do
	/home/mb31simi/NewPenum/penum/penum_slope --basisfile "./inppap/svpc-e1-d$DIM-$SEED.txt" --delta 0.9999 --prebeta $PREBETA --pruneparam 0.$PRUNEPARAM --beta $BETA --sheight 10 --amax $AMAX >> paper/svpc-e1-$DIM-$SEED-r3.log
done
